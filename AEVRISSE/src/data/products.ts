...
const productSeed: Array<{
  ...
  { id: "hoodie-03", name: "AEVRISSE Sage Form Hoodie", category: "hoodies", price: 8800, color: { name: "Sage", value: "#9fae9a" }, description: "Soft textured knit with a restrained sage tone and relaxed shoulder line.", bestSeller: true, visualScale: 1.16 },
  ...
  { id: "tshirt-03", name: "AEVRISSE Porcelain Crew Tee", category: "tshirts", price: 5100, color: { name: "Porcelain", value: "#e9e3d8" }, description: "A bright crewneck essential with refined weight and crisp finishing.", newArrival: true, visualScale: 1.78 },
  ...
  { id: "shirt-01", name: "AEVRISSE Chalk Studio Shirt", category: "shirts", price: 9600, color: { name: "Chalk", value: "#ded8ca" }, description: "Tailored cotton shirting with a pale chalk tone and precise collar line.", newArrival: true, visualScale: 2 },
  ...
  { id: "shirt-04", name: "AEVRISSE Stone Fluid Shirt", category: "shirts", price: 9800, color: { name: "Stone", value: "#b8afa0" }, description: "A fluid stone shirt balancing polish with ease.", visualScale: 2 },
  { id: "jacket-01", name: "AEVRISSE Obsidian Structured Blazer", category: "jackets", price: 16800, color: { name: "Obsidian", value: "#111111" }, description: "A sculpted black blazer with sharp lapels and a formal matte finish.", featured: true, bestSeller: true },
  ...
  { id: "jacket-03", name: "AEVRISSE Slate Work Jacket", category: "jackets", price: 13800, color: { name: "Slate", value: "#4a5254" }, description: "A utilitarian jacket refined into a quiet slate showroom piece.", visualScale: 2.05 },
  { id: "jacket-04", name: "AEVRISSE Nightfall Tailored Jacket", category: "jackets", price: 15900, color: { name: "Nightfall", value: "#161a20" }, description: "Dark tailoring with a close, composed silhouette and clean front line.", newArrival: true, visualScale: 2 },
  ...
  { id: "trousers-04", name: "AEVRISSE Charcoal Wide Trouser", category: "trousers", price: 12600, color: { name: "Charcoal", value: "#282726" }, description: "Wide-leg charcoal trousers with a calm, architectural fall.", visualScale: 2.4, visualOffsetY: -1 },
  ...
  { id: "coat-02", name: "AEVRISSE Camel Gallery Coat", category: "coats", price: 22600, color: { name: "Camel", value: "#a47b55" }, description: "A warm camel coat cut for gallery-like movement and soft authority.", bestSeller: true, newArrival: true, visualScale: 2.35, visualOffsetY: -1 },
  { id: "coat-03", name: "AEVRISSE Storm Wool Coat", category: "coats", price: 23200, color: { name: "Storm", value: "#363a3d" }, description: "A storm-toned coat with sculptural weight and quiet evening polish.", visualScale: 2.35, visualOffsetY: -1 },
...
export function getProductsByCategory(category: ProductCategory) {
  return products.filter((product) => product.active && product.category === category);
}

export const featuredProducts = products.filter((product) => product.active && product.featured);
export const bestSellerProducts = products.filter((product) => product.active && product.bestSeller);
export const newArrivalProducts = products.filter((product) => product.active && product.newArrival);
